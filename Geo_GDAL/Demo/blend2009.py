...
road_ds = road_driver.CreateDataSource(
    'C:\\Users\\thril\\Desktop\\blend\\data091204\\temp\\roadbuffer')
...
rail_ds = rail_driver.CreateDataSource(
    'C:\\Users\\thril\\Desktop\\blend\\data091204\\temp\\railbuffer')
...
memoryds = memorydriver.CreateDataSource(
    'C:\\Users\\thril\\Desktop\\blend\\data091204\\temp\\union')
...
new_raster = imgdriver.Create(
    r'C:\Users\thril\Desktop\blend\data091204\new_raster.tif', tfXSize, tfYSize, 1, gdal.GDT_Byte)
