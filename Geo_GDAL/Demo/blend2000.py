...
if lparea is None:
    ...
    sys.exit(1)
roadds = ogr.Open(
    'C:\\Users\\thril\\Desktop\\blend\\LP_2000\\temp\\roadbuffer\\buffer.shp')
road = roadds.GetLayerByIndex(0)
if road is None:
    print('cannot open road')
    sys.exit(1)
railds = ogr.Open(
    'C:\\Users\\thril\\Desktop\\blend\\LP_2000\\temp\\railbuffer\\buffer.shp')
...
memoryds = memorydriver.CreateDataSource(
    'C:\\Users\\thril\\Desktop\\blend\\LP_2000\\temp\\layerraster')
