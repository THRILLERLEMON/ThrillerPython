...
rect1 = [0, 0.58, 0.89, 0.5]  # [左, 下, 宽, 高] 规定的矩形区域 （全部是0~1之间的数，表示比例）
# rect2 = [0, 0, 0.2, 0.5]
rect3 = [0, 0, 0.15, 0.5]
rect4 = [0.21, 0, 0.15, 0.5]
rect5 = [0.42, 0, 0.15, 0.5]
rect6 = [0.63, 0, 0.1, 0.5]
rect7 = [0.79, 0, 0.1, 0.5]
...
plt.savefig('D:\\GIS_DATA\\GEE_DATA_landcover_V2\\CompareWithLCs\\CompareWithLCs_Kinds_SubPlot_NoChina1000.png',
            bbox_inches='tight')
