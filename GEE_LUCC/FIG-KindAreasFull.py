...
def main():
    ...
    for index, col in data.iteritems():
        fig = plt.figure(figsize=(4.9, 1.8), dpi=300)
        ax = fig.add_subplot(111)
        plt.plot(years, list(col), color='k', label=str(index), linewidth=2, linestyle='-', marker='o', ms=4.5)
        ...
        plt.savefig('D:\\OneDrive\\SharedFile\\GEE_V2\\ChangeRatioSlope\\FullFig' + str(index) + '.png',
