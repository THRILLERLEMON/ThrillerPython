...
def main():
    ...
    fnPath = 'D:\\OneDrive\\SharedFile\\GEE_V2\\showLUCC\\ChangeOfPixelsInSevenTimePoint\\'
    fnHead = 'ChangeOfPixelsInSevenTimePoint_Transition'
    fnTail = '.csv'
    ...
    nodeData = pd.read_csv(fnPath + 'ChangeOfPixelsInSevenTimePoint_Area' + fnTail, index_col='Year')
