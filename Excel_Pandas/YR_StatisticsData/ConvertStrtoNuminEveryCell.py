...
allData = pd.read_excel('C:\\Users\\thril\\Desktop\\主数据体1.6.xlsx', sheet_name="Sheet1")

firstpart = allData.iloc[:, 0:12]
newpart = getNewpart(allData)

newpartApplyMap = newpart.applymap(toNum)
newtable = pd.concat([firstpart, newpartApplyMap], axis=1)

print('hello')

newtable.to_excel('C:/Users/thril/Desktop/result.xlsx')
