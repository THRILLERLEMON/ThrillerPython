...
pars1 = ['乡(镇)个数', '建制镇个数', '村民委员会个数', '自来水受益村', '通电话村数', '年末总人口', '女性人口', '男性人口', '当年出生人口', '当年死亡人口', '常住人口',
         '年末总户数', '乡村户数', '第二产业从业人员数', '第三产业从业人员', '年末单位从业人员数', '国有单位从业人员', '城镇集体单位从业人员数', '其他单位从业人员数', '乡村从业人员数']
pars2 = ['农林牧渔业从业人员数', '城镇登记失业人员数', '工业总产值',  '人均国内生产总值', '地方财政一般预算收入', '各项税收', '地方财政一般预算支出', '一般性公共服务支出', '农林水事务支出',
         '科学技术支出', '医疗卫生支出', '教育支出', '年末金融机构各项存款余额', '居民储蓄存款余额', '年末金融机构各项贷款余额', '农林牧渔业总产值', '农业产值', '林业产值', '牧业产值', '渔业产值']
pars3 = ['农林牧渔服务业总产值', '农业机械总动力', '化肥使用量(折纯量)', '农药使用量', '农用塑料薄膜使用量', '农村用电量',  '旱涝保收面积', '机耕面积', '机电排灌面积', '农作物播种面积',
         '粮食作物播种面积', '稻谷播种面积', '小麦播种面积', '玉米播种面积', '豆类作物播种面积', '大豆播种面积', '薯类作物播种面积', '油料播种面积', '棉花播种面积', '蔬菜播种面积']
pars4 = ['瓜果种植面积', '果园面积', '粮食产量', '小麦产量', '玉米产量', '豆类产量', '大豆产量', '薯类产量', '油料产量', '棉花产量',
         '蔬菜产量', '园林水果产量', '苹果产量', '肉类总产量', '牛肉产量', '羊肉产量', '猪肉产量', '牛年末存栏头数',  '奶类产量', '禽蛋产量']
pars5 = ['水产品产量', '工业企业数', '工业总产值(现价)',  '从业人员年平均数', '主营业务收入', '本年应交增值税', '利润总额', '建筑业企业个数', '期末从业人员数', '建筑业总产值',
         '公路里程', '年末邮电局(所)数', '电信业务总量', '固定电话用户', '农村电话用户', '移动电话用户', '互联网宽带接入用户', '社会消费品零售总额', '城镇社会消费品零售总额', '乡村社会消费品零售总额']
pars6 = ['全社会固定资产投资', '新增固定资产投资', '建成区面积', '环境污染治理本年完成投资总额', '全社会用电量', '城镇固定资产投资', '房地产开发投资', '住宅开发投资', '商品房屋销售面积',
         '商品房屋销售额', '普通中学数', '小学数', '普通中学专任教师数', '小学专任教师数', '普通中学在校学生数', '小学在校学生数', '剧场、影剧院数', '公共图书馆图书总藏量', '医院、卫生院数', '医院、卫生院床位数']
pars7 = ['医院、卫生院卫生技术人员数', '执业(助理)医师', '城镇在岗职工平均人数', '城镇在岗职工工资总额', '城镇居民人均可支配收入', '农村居民人均纯收入', '农村居民人均生活消费支出', '农民人均住房面积', '各种社会福利收养性单位数', '各种社会福利收养性单位床位数',
         '城镇基本养老保险参保人数', '城镇基本医疗保险参保人数', '失业保险参保人数', '城镇居民最低生活保障人数', '农村居民最低生活保障人数', '新型农村合作医疗参保人数', '新型农村社会养老保险参保人数', '行政区域土地面积', '森林面积', '当年造林面积']
pars8 = ['耕地面积', '水田面积', '水浇地面积', '基建占地面积', '年内减少耕地面积', '家禽存栏', '在岗职工数', '工业二氧化硫排放量',
         '烟(粉)尘排放量', '氮氧化物排放量', '年末耕地总资源', '退耕还林还草面积', '邮政业务总量', '邮电业务总量', '高等级公路里程', '农用地膜使用量', '城镇生活污水处理率', '污水处理厂数', '垃圾处理站数', '通有线电视村数']
