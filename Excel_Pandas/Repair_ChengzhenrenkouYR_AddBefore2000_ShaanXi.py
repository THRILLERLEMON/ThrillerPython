...
sys.stdout = Logger('OutLog_ShaanXi_repairCZRK.txt')
print(printpath)
...
allCountryData = pd.read_excel(
    'C:\\Users\\thril\\Desktop\\OutputAll_Ordered-SaX_Chengzhenrenkou.xlsx', sheet_name="Sheet1")
...
allCountryData.to_excel(
    'D:\\OneDrive\\SharedFile\\EXCEL 数据处理\\EXCELwork201908_linux_2ED\\AfterSX_SaX_repairCZRK.xlsx', encoding='gbk')
