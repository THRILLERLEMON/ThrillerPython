...
if lparea is None:
    ...
    sys.exit(1)
roadds=ogr.Open('C:\\Users\\thril\\Desktop\\blend\\data091204\\newroad.shp')
road=roadds.GetLayerByIndex(0)
if road is None:
    print('cannot open road')
    sys.exit(1)
railds=ogr.Open('C:\\Users\\thril\\Desktop\\blend\\data091204\\newrail.shp')
...
road_ds = road_driver.CreateDataSource('C:\\Users\\thril\\Desktop\\blend\\data091204\\temp\\roadbuffer')
...
for i in range(roadfeatureCount):
    ...
    featgeom=feat.geometry()
    buff_geom=featgeom.Buffer(0.0005)
...
rail_ds = rail_driver.CreateDataSource('C:\\Users\\thril\\Desktop\\blend\\data091204\\temp\\railbuffer')
...
memoryds = memorydriver.CreateDataSource('C:\\Users\\thril\\Desktop\\blend\\data091204\\temp\\union')
union_lyr = memoryds.CreateLayer('union',road.GetSpatialRef())
roadbuff_lyr.Union(railbuff_lyr,union_lyr)
print('already union')

tf=gdal.Open(r'C:\Users\thril\Desktop\blend\classified2009-01-01.tif')
if tf is None:
...
new_raster = imgdriver.Create(r'C:\Users\thril\Desktop\blend\data091204\new_raster.tif', tfXSize, tfYSize, 1, gdal.GDT_Byte)
...
resultPath = r'C:\Users\thril\Desktop\blend\data091204\result_landuse.tif'
